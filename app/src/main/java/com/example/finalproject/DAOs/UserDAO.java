...
public interface UserDAO {
    ...
    @Query("SELECT * FROM tblUser WHERE " +
            ...
            "CASE WHEN :isSortedByLastName = 1 THEN " + Constants.USER_LAST_NAME_KEY + " END ASC")
    List<User> getUsersContainingAndSorted(String search, int isSortedByFirstName, int isSortedByLastName);
    @Insert
